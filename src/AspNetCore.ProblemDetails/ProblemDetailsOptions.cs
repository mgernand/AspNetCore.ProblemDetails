...
namespace MadEyeMatt.AspNetCore.ProblemDetails
{
    ...
    public sealed class ProblemDetailsOptions
    {
        ...
        public ProblemDetailsOptions()
        {
            ...
            this.IncludeExceptionDetails ??= (context, exception) =>
        ...
        /// </summary>
        public Func<HttpContext, Exception, Microsoft.AspNetCore.Mvc.ProblemDetails, bool> LogUnhandledException
        {
            get;
            set;
        }
        ...
        public void MapStatusCode<TException>(
            ...
            Func<HttpContext, TException, HttpStatusCode, ProblemDetailsFactory,
                Microsoft.AspNetCore.Mvc.ProblemDetails> problemDetailsMapping)
        ...
        public void Map<TException>(
            ...
            Func<HttpContext, TException, HttpStatusCode, ProblemDetailsFactory,
                Microsoft.AspNetCore.Mvc.ProblemDetails> problemDetailsMapping = null)
            where TException : Exception
        {
            StatusCodeMapper mapper = new StatusCodeMapper(
                ...
                (context, exception, httpStatusCode, problemDetailsFactory) => problemDetailsMapping?.Invoke(context,
                    (TException)exception, httpStatusCode, problemDetailsFactory));
        ...
        internal bool TryMapProblemDetails(HttpContext context, Exception exception, HttpStatusCode httpStatusCode,
            ProblemDetailsFactory problemDetailsFactory, out Microsoft.AspNetCore.Mvc.ProblemDetails problemDetails)
        {
            if (exception is null)
            {
                problemDetails = null;
            ...
            foreach (StatusCodeMapper statusCodeMapper in this.StatusCodeMappings)
            {
                if (statusCodeMapper.TryMapProblemDetails(context, exception, httpStatusCode, problemDetailsFactory,
                        out problemDetails))
                {
        ...
        internal sealed class StatusCodeMapper
        {
            ...
            private readonly
                Func<HttpContext, Exception, HttpStatusCode, ProblemDetailsFactory,
                    Microsoft.AspNetCore.Mvc.ProblemDetails> problemDetailsMapping;
            ...
            public bool TryMapProblemDetails(HttpContext context, Exception exception, HttpStatusCode httpStatusCode,
                ProblemDetailsFactory problemDetailsFactory, out Microsoft.AspNetCore.Mvc.ProblemDetails problemDetails)
            {
                if (this.ShouldMap(context, exception))
                {
                    ...
                    {
                        problemDetails =
                            this.problemDetailsMapping(context, exception, httpStatusCode, problemDetailsFactory);
                        return true;
                    }
                    catch
                    {
